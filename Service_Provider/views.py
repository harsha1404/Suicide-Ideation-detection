...
def View_Message_Text_Type_Ratio(request):
    ...
    return render(request, 'SProvider/View_Message_Text_Type_Ratio.html', {'objs': obj})
...
def View_Prediction_Of_Message_Text_Type(request):
    obj =detecting_Type.objects.all()
    return render(request, 'SProvider/View_Prediction_Of_Message_Text_Type.html', {'list_objects': obj})
...
def Download_Trained_DataSets(request):
    ...
    for my_row in data:
        ...
        ws.write(row_num, 0, my_row.Text_Id, font_style)
        ws.write(row_num, 1, my_row.Message_Text, font_style)
